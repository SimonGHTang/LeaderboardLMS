...
module.exports = function(app) {
    app.get("course/:course_id/leaderboard/:leaderboard_id/rankingSections", AuthenticationService.isStudentOrAdminForCourse, RankingSectionsController.getAllRankingSections);
